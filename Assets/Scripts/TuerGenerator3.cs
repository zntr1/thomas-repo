...
public class TuerGenerator3 : MonoBehaviour
{
    ...
    // Objekt-Bestandteile
    private string oBT_Tuerblatt = "";
    private string oBT_Zarge = "";
    private string oBT_DrueckerFalz = "";
    private string oBT_DrueckerZier = "";
    private string oBT_Band1 = "";
    private string oBT_Band2 = "";
    private string oBT_Bandaufnahme1 = "";
    private string oBT_Bandaufnahme2 = "";
    private string oBT_Schlosskasten = "";
    private string oBT_Schliessblech = "";
    private string oBT_Schwelle = "";
    // Objekt-Rotationen
...
//
    ...
    string[,] materialien3 = new string[8, 3] {
        { "Material/RAL/RAL9001_Cremeweiss",  "Material/03_Metall/03-2_Alluminium/M_2K_CC0T_Metal032_2K-JPG", "Material/10_zerbrechlich/10-1_Glas/Glas_001" },
        { "Material/RAL/RAL3000_Feuerrot",  "Material/03_Metall/03-2_Alluminium/M_2K_CC0T_Metal032_2K-JPG", "Material/10_zerbrechlich/10-1_Glas/Glas_001" },
        { "Material/RAL/RAL7002_Olivgrau",  "Material/03_Metall/03-2_Alluminium/M_2K_CC0T_Metal032_2K-JPG", "Material/10_zerbrechlich/10-1_Glas/Glas_001" },
        { "Material/04_Holz/04-1_pur/M_1K_3DTE_Wood_020",  "Material/03_Metall/03-2_Alluminium/M_2K_CC0T_Metal032_2K-JPG", "Material/10_zerbrechlich/10-1_Glas/Glas_001" },
        { "Material/04_Holz/04-1_pur/M_2K_CC0T_Wood007_2K-JPG", "Material/03_Metall/03-2_Alluminium/M_2K_CC0T_Metal032_2K-JPG", "Material/10_zerbrechlich/10-1_Glas/Glas_001" },
        { "Material/04_Holz/04-1_pur/M_2K_CC0T_Wood014_2K-JPG", "Material/03_Metall/03-2_Alluminium/M_2K_CC0T_Metal032_2K-JPG", "Material/10_zerbrechlich/10-1_Glas/Glas_001" },
        { "Material/04_Holz/04-1_pur/M_2K_CC0T_Wood026_2K-JPG", "Material/03_Metall/03-2_Alluminium/M_2K_CC0T_Metal032_2K-JPG", "Material/10_zerbrechlich/10-1_Glas/Glas_001" },
        { "Material/04_Holz/04-1_pur/M_2K_TCAN_wood_0009_2k_PYaK2S", "Material/03_Metall/03-2_Alluminium/M_2K_CC0T_Metal032_2K-JPG", "Material/10_zerbrechlich/10-1_Glas/Glas_001" }
    };
    ...
    string[,] mTuerblatt = {
            ...
            { "Material/RAL/RAL7002_Olivgrau", "Material/03_Metall/03-2_Alluminium/M_2K_CC0T_Metal032_2K-JPG", "Material/10_zerbrechlich/10-1_Glas/Glas_001" },
            { "Material/04_Holz/04-1_pur/M_1K_3DTE_Wood_020",  "Material/03_Metall/03-2_Alluminium/M_2K_CC0T_Metal032_2K-JPG", "Material/10_zerbrechlich/10-1_Glas/Glas_001" },
            { "Material/04_Holz/04-1_pur/M_2K_CC0T_Wood028_2K-JPG",  "Material/03_Metall/03-2_Alluminium/M_2K_CC0T_Metal032_2K-JPG", "Material/10_zerbrechlich/10-1_Glas/Glas_001" },
            { "Material/04_Holz/04-1_pur/M_2K_TCAN_wood_0012_2k_U9kCUd",  "Material/03_Metall/03-2_Alluminium/M_2K_CC0T_Metal032_2K-JPG", "Material/10_zerbrechlich/10-1_Glas/Glas_001" }
    };
    //string[,] mTuerblatt = {
    //        { "Material/04_Holz/04-1_pur/M_1K_3DTE_Wood_020"},
    //        { "Material/04_Holz/04-1_pur/M_2K_CC0T_Wood028_2K-JPG"},
    //        { "Material/04_Holz/04-1_pur/M_2K_TCAN_wood_0012_2k_U9kCUd"}
    //};

    string[,] mZarge= {
            { "M_1K_3DTE_Wood_020", "M_2K_CC0T_Wood025_2K-JPG", "M_2K_CGBO_Wood_07" }
    };
    string[,] mDrueckerFalz = {
            { "M_2K_CC0T_Metal032_2K-JPG" }
    };
    string[,] mDrueckerZier = {
            { "M_2K_CC0T_Metal032_2K-JPG" }
    };
    string[,] mBand1 = {
            { "M_2K_CC0T_Metal032_2K-JPG" }
    ...
    string[,] mBandaufnahme1 = {
            { "M_2K_CC0T_Metal032_2K-JPG" }
    };
    string[,] mBandaufnahme2 = {
            { "M_2K_CC0T_Metal032_2K-JPG" }
    };
    string[,] mSchlosskasten = {
             { "M_2K_CC0T_Metal032_2K-JPG" }
    };
    string[,] mSchliessblech = {
            { "M_2K_CC0T_Metal032_2K-JPG" }
    };
    string[,] mSchwelle = {
            {  }
    ...
    void toggleMaterial3()
    {
        ...
        if (aktuellesMaterial < (mTuerblatt.GetLength(0) - 1))
        {
            aktuellesMaterial += 1;
        }
        else
        ...
        Material[] yourMaterial = new Material[mTuerblatt.GetLength(1)];


        // übernimm alle Materialien von Json in Material-Array
        for (int i = 0; i < mTuerblatt.GetLength(1); i++)
        {
            yourMaterial[i] = Resources.Load<Material>(mTuerblatt[aktuellesMaterial, i]);
        }
